...
const CreateCalendar = () => {
  ...
  const copyShareLink = async () => {
    const shareUrl = `${window.location.origin}/availability-calendar/#/share/${createdCalendar.shareId}`;
    try {
            ...
            <div className="form-group">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  value={`${window.location.origin}/availability-calendar/#/share/${createdCalendar.shareId}`}
                  readOnly
                />
                <button
