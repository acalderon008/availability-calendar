      ...
      <div className="container">
        <div className="card text-center" style={{ maxWidth: '600px', margin: '0 auto' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', marginBottom: '1rem' }}>
            The share link you used is invalid or the calendar has been deleted.
          </p>
        ...
        <div className="flex justify-between items-start gap-4" style={{ flexWrap: 'wrap' }}>
          <div>
            <div className="flex items-center gap-2 mb-2">
              <Link to="/" className="btn btn-outline" style={{ textDecoration: 'none', padding: '0.25rem 0.5rem' }}>
                <ArrowLeft size={16} />
                Back
              </Link>
